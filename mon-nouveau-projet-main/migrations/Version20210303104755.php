 ...
 */
final class Version20210303104755 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE editeur (id INT AUTO_INCREMENT NOT NULL, edediteur VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE produit ADD genre_id INT NOT NULL, ADD fournisseur_id INT NOT NULL, ADD editeur_id INT DEFAULT NULL, ADD relation VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP genre_id, DROP fournisseur_id, DROP editeur_id, DROP relation');
    }
}
